...
let allProjects=[oschadBank,biosporin,koblevo,lenovo,oschadBank2,liveChem,beIt,dpsu,laferobreon,novaPoshta,rabota,
...
export {showPartners,addProjectsListener,allProjects};